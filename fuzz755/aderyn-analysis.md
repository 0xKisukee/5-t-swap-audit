...
- Found in src/TSwapPool.sol [Line: 329](src/TSwapPool.sol#L329)

	```solidity
	    function swapExactInput(
	```

- Found in src/TSwapPool.sol [Line: 370](src/TSwapPool.sol#L370)

	```solidity
	    function swapExactOutput(
	```

- Found in src/TSwapPool.sol [Line: 398](src/TSwapPool.sol#L398)
...
- Found in src/TSwapPool.sol [Line: 325](src/TSwapPool.sol#L325)

	```solidity
	            ((inputReserves * outputAmount) * 10000) /
	```

- Found in src/TSwapPool.sol [Line: 437](src/TSwapPool.sol#L437)
...
- Found in src/TSwapPool.sol [Line: 495](src/TSwapPool.sol#L495)

	```solidity
	                1e18,
	```

- Found in src/TSwapPool.sol [Line: 506](src/TSwapPool.sol#L506)
